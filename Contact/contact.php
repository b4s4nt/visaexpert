  ...
  <body >
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">OneDayVisa</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="#">NormalVisa</a></li>
          </ul>
        </li>
							<!--	<li class="dropdown">
    ...
    <div class="col-lg-4">
                        ...
                        <form  role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                               ...
                               <input class="form-control" name="meg" value="usermessage" type="hidden">
                        ...
                        <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="clearfix"></div>
                                 <div class="col-md-3">
                                <label>DOB</label>
                                <input class="form-control" placeholder=" Enter your date of birth of Depandants' " name="dob2" >
                                </div>
                                 <div class="col-md-1"></div>
