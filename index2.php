                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="services.html">OneDayVisa</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="services.html">NormalVisa</a></li>
                                </ul>
                            </li>
                            <!--  <li class="dropdown">
...
</li>  -->                 <li><a href="testimonial.html">Testimonial</a></li>
            ...
            <div class="container">
                ...
                <div class="col-md-3">  
                    ...
                    <hr>
                        ...
                        <div class="container-fluid"   style=" background-color: #f2f2f2; position: relative; overflow: hidden; height: 300px;">
                    ...
                    <div class="fb-like-box" data-href="http://www.facebook.com/pages/UKVisaExpertcom-London/311251652248081" data-width="260" data-colorscheme="light" data-show-faces="true" data-border-color="yellow" data-stream="true" data-header="true"></div>
